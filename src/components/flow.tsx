...
export function Connector() {
  return (
    <svg viewBox="0 0 84 24" className="uc-conn" aria-hidden="true">
      ...
      <circle cx="78" cy="12" r="3" fill="#5B8CFF" stroke="none" />
    </svg>
  )
}

/** Minimal phone outline for the statement diagram. */
export function MiniPhone() {
  return (
    <svg viewBox="0 0 64 128" className="mini-phone" aria-hidden="true">
      <rect x="2" y="2" width="60" height="124" rx="14" fill="rgba(255,255,255,0.85)" stroke="currentColor" strokeWidth="1.6" />
      ...
      <NfcMark x={17} y={46} scale={1.1} color="#5B8CFF" />
